...
<body>
    ...
    <div class="top-bar">
        <h1>ZALMAN T8</h1>
        <p><a href="../index.php">Acceuil</a> / <a href="../portfolio.html">Produits</a> / ZALMAN T8</p>
    </div>
    <!-- end top-bar -->
    ...
    <div class="container main-container">
        <div class="col-md-12">
            <img src="../img/Produits/Boitier/ZALMAN_T8.jpg" alt="" class="img-responsive center2" />
            <div class="h-30"></div>
        </div>
        <div class="col-md-12">
            <h3 class="text-uppercase">ZALMAN T8</h3>
            <h4>54.95€</h4>
            <div class="h-30"></div>
        </div>
        ...
        <div class="col-md-9">
            <p>
                Voici le boitier Zalman T8, un écrin simple et efficace pour votre configuration de jeu.
                Il permet d'installer tous types de composants pour créer le PC de vos rêves
                et possède un liseré d'éclairage RGB.
            </p>
        </div>
